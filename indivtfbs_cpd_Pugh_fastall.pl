...
# print header
print OUT "TF name\tNum. CPDs at TF midpoint [$peakstart to $peakend]\tNum. CPDs elsewhere\tNum. of TFBS\tPeak CPD Density\tFlank CPD Density\tPeak-to-Flank Ratio\tNorm. Ratio\n";
