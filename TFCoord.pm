...
sub new
{
	...
	#my $tf_file_name = "../Hap235_RF_targets_chxmx_saccer2_fix3.bed";
	#my $tf_file_name = "../Hap235_RF_targets_NOTchxmx_saccer2_fix3.bed";
	#my $tf_file_name = "../hap235_motifs_yeastsaccer2_ORF100bp_fix3.bed";
